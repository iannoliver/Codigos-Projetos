const apiKey = '100d86ccbeeab3266269ccd7bdc72435';
...
function fetchWeatherData(location) {
    ...
    const apiUrl = `https://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=100d86ccbeeab3266269ccd7bdc72435&units=metric`;
